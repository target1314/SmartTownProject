 ...
 * 供外部get请求调用
 */
function httpGet(url, params, onSuccess, onFailed) {
  console.log("请求方式：", "GET")
  httpGetRequest(url, params, "GET", onSuccess, onFailed);
}
 ...
 * @onFailed  失败回调
 */
function httpGetRequest(url, params, method, onSuccess, onFailed) {
